object frmRelFinanceiro: TfrmRelFinanceiro
  ...
  object QuickRep1: TQuickRep
    ...
    object ColumnHeaderBand1: TQRBand
      ...
      object QRLabel1: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Movimenta'#231#227'o Financeira Di'#225'ria'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -19
    ...
    object DetailBand1: TQRBand
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'QyFinanceiro.Dt_pagto'
        Mask = 'R$ ##.00'
        FontSize = 8
      end
    ...
    object SummaryBand1: TQRBand
      ...
      object QRLabel8: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Total Movimenta'#231#227'o:'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
  ...
  object QyFinanceiro: TQuery
    ...
    SQL.Strings = (
      'Select * from Vw_Carnes'
      'where Parcela = 1'
      'and  CodSerie = 16'
      'and Situacao = '#39'PAGO'#39)
    Left = 81
    Top = 5
    ...
    object QyFinanceiroAluno: TStringField
      FieldName = 'Aluno'
      Origin = 'BDACADEMICO.Vw_Carne.Aluno'
      Size = 80
    end
    object QyFinanceiroCodForma: TIntegerField
      FieldName = 'CodForma'
      Origin = 'BDACADEMICO.Vw_Carne.CodForma'
    end
    object QyFinanceiroFormaPagto: TStringField
      FieldName = 'FormaPagto'
      Origin = 'BDACADEMICO.Vw_Carne.FormaPagto'
      Size = 30
    end
    object QyFinanceiroCodSerie: TIntegerField
      FieldName = 'CodSerie'
      Origin = 'BDEXPOENTE.Vw_Carnes.CodSerie'
    end
    object QyFinanceiroSerie: TStringField
      FieldName = 'Serie'
      Origin = 'BDEXPOENTE.Vw_Carnes.Serie'
      Size = 50
    end
    object QyFinanceiroTurma: TStringField
      FieldName = 'Turma'
      Origin = 'BDEXPOENTE.Vw_Carnes.Turma'
      FixedChar = True
      Size = 1
    end
    object QyFinanceiroStatus: TStringField
      FieldName = 'Status'
      Origin = 'BDEXPOENTE.Vw_Carnes.Status'
      FixedChar = True
      Size = 15
    end
    object QyFinanceiroNivel: TStringField
      FieldName = 'Nivel'
      Origin = 'BDEXPOENTE.Vw_Carnes.Nivel'
      Size = 50
    end
  end
end
