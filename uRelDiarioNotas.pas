...
type
  TfrmRelDiarioNotas = class(TForm)
    QuickRep2: TQuickRep;
    DetailBand2: TQRBand;
    QRShape85: TQRShape;
    QRShape84: TQRShape;
...
var
  frmRelDiarioNotas: TfrmRelDiarioNotas;

implementation

{$R *.DFM}

procedure TfrmRelDiarioNotas.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  qymaster.close;
  qydetalhe.close;
  Release;
  frmRelDiarioNotas := nil;
end;

procedure TfrmRelDiarioNotas.QyDetalheCalcFields(DataSet: TDataSet);
var
 Valor:STRING;
