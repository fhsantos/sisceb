unit uRelDiarioNotasSemPreenchimento_EJA;
...
type
  TfrmRelDiarioNotasSemPreenchimento_EJA = class(TForm)
    QuickRep1: TQuickRep;
...
var
  frmRelDiarioNotasSemPreenchimento_EJA: TfrmRelDiarioNotasSemPreenchimento_EJA;

implementation

{$R *.DFM}

procedure TfrmRelDiarioNotasSemPreenchimento_EJA.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  qymaster.close;
  qydetalhe.close;
  Release;
  frmRelDiarioNotasSemPreenchimento_EJA := nil;
end;

procedure TfrmRelDiarioNotasSemPreenchimento_EJA.QyDetalheCalcFields(DataSet: TDataSet);
var
 Valor:STRING;
