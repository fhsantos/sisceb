object frmRelDebitos: TfrmRelDebitos
  Left = 375
  Top = 216
  Width = 842
  Height = 667
  ...
  object QuickRep2: TQuickRep
    ...
    object QRSubDetail1: TQRSubDetail
      ...
      object QRExpr21: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'QyFinanceiro.Parcela'
        FontSize = 8
      end
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'QyFinanceiro.Dt_venc'
        FontSize = 7
      end
    ...
    object SummaryBand1: TQRBand
      ...
      object QRExpr6: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(QyFinanceiro.Valor)'
        Mask = 'R$ ##.00'
        FontSize = 12
      end
      object QRExpr7: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(QyFinanceiro.Valor + QyFinanceiro.Multa)'
        Mask = 'R$ ##.00'
        FontSize = 12
      end
    end
  ...
  object QyFinanceiro: TQuery
    ...
    object QyFinanceiroMatricula: TIntegerField
      FieldName = 'Matricula'
      Origin = 'BDEXPOENTE.Tb_Carne.Matricula'
    end
    ...
    object QyFinanceiroTotal: TFloatField
      FieldKind = fkCalculated
      FieldName = 'Total'
      DisplayFormat = 'R$ ##.00'
      Calculated = True
