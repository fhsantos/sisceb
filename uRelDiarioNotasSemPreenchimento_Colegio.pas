unit uRelDiarioNotasSemPreenchimento_Colegio;
...
type
  TfrmRelDiarioNotasSemPreenchimento_Colegio = class(TForm)
    QuickRep1: TQuickRep;
...
var
  frmRelDiarioNotasSemPreenchimento_Colegio: TfrmRelDiarioNotasSemPreenchimento_Colegio;

implementation

{$R *.DFM}

procedure TfrmRelDiarioNotasSemPreenchimento_Colegio.FormClose(Sender: TObject;
...
begin
 try
  ...
  qydetalhe.close;
  Release;
  frmRelDiarioNotasSemPreenchimento_Colegio := nil;
 except
 end;
end;

procedure TfrmRelDiarioNotasSemPreenchimento_Colegio.QyDetalheCalcFields(DataSet: TDataSet);
var
 Valor:STRING;
