object FrmRelSimuladoModeloNovo: TFrmRelSimuladoModeloNovo
  Left = 175
  Top = 217
  Width = 1036
  Height = 778
  ...
  object QuickRep1: TQuickRep
    ...
    object DetailBand1: TQRBand
      ...
      object QRExpr3: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'QyCandidatos.Disciplina'
        FontSize = 10
      end
      ...
      object QRLabel258: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = '1. Utilize apenas caneta esferogr'#225'fica azul ou preta.'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = 33023
        Font.Height = -9
      ...
      object QRLabel259: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = '2. Fa'#231'a marcas fortes conforme modelo.'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = 33023
        Font.Height = -9
      ...
      object QRLabel260: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = '3. N'#227'o marque assim:'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = 33023
        Font.Height = -9
      ...
      object QRLabel261: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = '4. N'#227'o rasure esta folha.'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = 33023
        Font.Height = -9
      ...
      object QRLabel262: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = '6. Ver abaixo modelo como deve marcar:'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = 33023
        Font.Height = -9
      ...
      object QRLabel263: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = '5. N'#227'o fa'#231'a marcas com l'#225'pis para apagar depois.'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = 33023
        Font.Height = -9
      ...
      object QRLabel266: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'N'#195'O RASURAR O CART'#195'O USAR CANETA'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = 4227327
        Font.Height = -9
      ...
      object QRLabel267: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'ESFEROGR'#193'FICA AZUL OU PRETA'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = 4227327
        Font.Height = -9
  ...
  object QyCandidatos: TQuery
    DatabaseName = 'BDESisceb'
    SQL.Strings = (
      'select * from Vw_Matricula_Disciplinas'
      'where Ano = 2010 and CodSerie = 11 '
      'and CodDisciplina = 6'
      'order by Aluno')
    Left = 8
    Top = 19
    object QyCandidatosMatricula: TIntegerField
      FieldName = 'Matricula'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.Matricula'
    end
    object QyCandidatosCodDisciplina: TIntegerField
      FieldName = 'CodDisciplina'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.CodDisciplina'
    end
    object QyCandidatosAno: TIntegerField
      FieldName = 'Ano'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.Ano'
    end
    object QyCandidatosTurma: TStringField
      FieldName = 'Turma'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.Turma'
      FixedChar = True
      Size = 1
    end
    object QyCandidatosDisciplina: TStringField
      FieldName = 'Disciplina'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.Disciplina'
      Size = 30
    end
    object QyCandidatosAluno: TStringField
      FieldName = 'Aluno'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.Aluno'
      Size = 80
    end
    object QyCandidatosUnid1: TStringField
      FieldName = 'Unid1'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.Unid1'
      FixedChar = True
      Size = 4
    end
    object QyCandidatosUnid2: TStringField
      FieldName = 'Unid2'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.Unid2'
      FixedChar = True
      Size = 4
    end
    object QyCandidatosF1: TIntegerField
      FieldName = 'F1'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.F1'
    end
    object QyCandidatosF2: TIntegerField
      FieldName = 'F2'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.F2'
    end
    object QyCandidatosF3: TIntegerField
      FieldName = 'F3'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.F3'
    end
    object QyCandidatosSit: TStringField
      FieldName = 'Sit'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.Sit'
      FixedChar = True
      Size = 4
    end
    object QyCandidatosCargaHoraria: TFloatField
      FieldName = 'CargaHoraria'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.CargaHoraria'
    end
    object QyCandidatosCodSerie: TIntegerField
      FieldName = 'CodSerie'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.CodSerie'
    end
    object QyCandidatosSerie: TStringField
      FieldName = 'Serie'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.Serie'
      Size = 50
    end
    object QyCandidatosNivel: TStringField
      FieldName = 'Nivel'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.Nivel'
      Size = 50
    end
    object QyCandidatosUnid3: TStringField
      FieldName = 'Unid3'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.Unid3'
      FixedChar = True
      Size = 4
    end
    object QyCandidatosUnid4: TStringField
      FieldName = 'Unid4'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.Unid4'
      FixedChar = True
      Size = 4
    end
    object QyCandidatosPF: TStringField
      FieldName = 'PF'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.PF'
      FixedChar = True
      Size = 4
    end
    object QyCandidatosRF: TStringField
      FieldName = 'RF'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.RF'
      FixedChar = True
      Size = 4
    end
    object QyCandidatosSituacao: TStringField
      FieldName = 'Situacao'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.Situacao'
      FixedChar = True
      Size = 15
    end
  end
