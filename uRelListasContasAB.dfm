object FrmRelListasContasPG: TFrmRelListasContasPG
  Left = 251
  Top = 239
  Width = 823
  Height = 610
  ...
  object QuickRep1: TQuickRep
    ...
    object ColumnHeaderBand1: TQRBand
      ...
      object QRLabel4: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'MOVIMENTO - CAIXA DI'#193'RIO'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -17
    ...
    object DetailBand1: TQRBand
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'QyListaContas.Conta + '#39' '#39' + QyListaContas.Obs'
        FontSize = 9
      end
      object QRExpr2: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'QyListaContas.DtPagto'
        FontSize = 9
      end
      object QRExpr3: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'QyListaContas.VlEntrada'
        Mask = 'R$ ##.00'
        FontSize = 9
      end
      object QRExpr4: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'QyListaContas.VlSaida'
        Mask = 'R$ ##.00'
        FontSize = 9
      end
    ...
    object SummaryBand1: TQRBand
      ...
      object QRExpr5: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(QyListaContas.VlEntrada)'
        Mask = 'R$ ##.00'
        FontSize = 10
      end
      ...
      object QRExpr6: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(QyListaContas.VlSaida)'
        Mask = 'R$ ##.00'
        FontSize = 10
      end
      ...
      object QRExpr7: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(QyListaContas.VlEntrada) - SUM(QyListaContas.VlSaida)'
        Mask = 'R$ ##.00'
        FontSize = 10
      end
    end
  ...
  object QyListaContas: TQuery
    OnCalcFields = QyListaContasCalcFields
    DatabaseName = 'BDESisceb'
    SQL.Strings = (
      'Select * From Vw_MovCaixa')
    Left = 20
    Top = 42
    object QyListaContasCodMov: TIntegerField
      FieldName = 'CodMov'
      Origin = 'BDSANCLAU.Vw_MovCaixa.CodMov'
    end
    object QyListaContasCodDescricao: TIntegerField
      FieldName = 'CodDescricao'
      Origin = 'BDSANCLAU.Vw_MovCaixa.CodDescricao'
    end
    object QyListaContasDtPagto: TDateTimeField
      FieldName = 'DtPagto'
      Origin = 'BDSANCLAU.Vw_MovCaixa.DtPagto'
    end
    object QyListaContasValor: TFloatField
      FieldName = 'Valor'
      Origin = 'BDSANCLAU.Vw_MovCaixa.Valor'
    end
    object QyListaContasObs: TStringField
      FieldName = 'Obs'
      Origin = 'BDSANCLAU.Vw_MovCaixa.Obs'
      Size = 100
    end
    object QyListaContasSituacao: TStringField
      FieldName = 'Situacao'
      Origin = 'BDSANCLAU.Vw_MovCaixa.Situacao'
      FixedChar = True
      Size = 15
    end
    object QyListaContasConta: TStringField
      FieldName = 'Conta'
      Origin = 'BDSANCLAU.Vw_MovCaixa.Conta'
      Size = 100
    end
    object QyListaContasTipo: TStringField
      FieldName = 'Tipo'
      Origin = 'BDSANCLAU.Vw_MovCaixa.Tipo'
      FixedChar = True
      Size = 1
    end
    object QyListaContasVlEntrada: TFloatField
      FieldKind = fkCalculated
      FieldName = 'VlEntrada'
      Calculated = True
    end
    object QyListaContasVlSaida: TFloatField
      FieldKind = fkCalculated
      FieldName = 'VlSaida'
      Calculated = True
    end
