object frmRelBoletim: TfrmRelBoletim
  Left = 186
  Top = 112
  Width = 902
  Height = 667
  ...
  object QuickRep2: TQuickRep
    ...
    object QRSubDetail1: TQRSubDetail
      ...
      object QRExpr7: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(QyNotas.F1 + QyNotas.F2 + QyNotas.F3)'
        FontSize = 7
      end
    ...
    object SummaryBand1: TQRBand
      ...
      object QRExpr14: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'QyMaster.Pai + '#39' '#39' + '#39' '#39' + '#39'e'#39' + '#39' '#39' + '#39' '#39' + QyMaster.Mae'
        FontSize = 7
      end
      ...
      object QRLabel10: TQRLabel
        ...
        AutoStretch = False
        Caption = 
          'caso as informa'#231#245'es supracitada constar erros por favor, procura' +
          'r a secretaria da escola para corre'#231#227'o.'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
  ...
  object QyMaster: TQuery
    ...
    SQL.Strings = (
      ...
      'where CodSerie = 15 and Turma = '#39'A'#39' and'
      'Situacao = '#39'Normal'#39' and Ano = 2006')
    Left = 504
    ...
    object QyMasterDt_Matricula: TDateTimeField
    ...
    object QyMasterCodNivel: TIntegerField
      FieldName = 'CodNivel'
      Origin = 'BDEXPOENTE.Vw_AlunosMatricula.CodNivel'
    end
    object QyMasterCI: TStringField
      FieldName = 'CI'
      Origin = 'BDEXPOENTE.Vw_AlunosMatricula.CI'
      Size = 50
    end
    object QyMasterPai: TStringField
      FieldName = 'Pai'
      Origin = 'BDEXPOENTE.Vw_AlunosMatricula.Pai'
      Size = 80
    end
    object QyMasterMae: TStringField
      FieldName = 'Mae'
      Origin = 'BDEXPOENTE.Vw_AlunosMatricula.Mae'
      Size = 80
    end
    object QyMasterDt_Nasc: TDateTimeField
      FieldName = 'Dt_Nasc'
      Origin = 'BDEXPOENTE.Vw_AlunosMatricula.Dt_Nasc'
    end
    ...
    object QyMasterSituacao: TStringField
      FieldName = 'Situacao'
      Origin = 'BDSISCEB.Vw_AlunosMatricula.Situacao'
      FixedChar = True
      Size = 15
    end
  end
  object QyNotas: TQuery
    ...
    object QyNotasCargaHoraria: TFloatField
    ...
    object QyNotasMedFinal: TFloatField
      FieldKind = fkCalculated
      FieldName = 'MedFinal'
      Calculated = True
    end
    ...
    object QyNotasMD1S: TStringField
      FieldKind = fkCalculated
      FieldName = 'MD1S'
      Size = 4
      Calculated = True
  ...
  object QyConfig: TQuery
    ...
    object QyConfigMediaEja: TFloatField
      FieldName = 'MediaEja'
      Origin = 'BDSISCEB.Tb_Config.MediaEja'
    end
  end
end
