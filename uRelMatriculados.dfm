object frmRelMatriculados: TfrmRelMatriculados
  Left = 188
  Top = 117
  Width = 902
  Height = 527
  ...
  object QuickRep2: TQuickRep
    ...
    object ColumnHeaderBand1: TQRBand
      ...
      object QRLabel12: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Rela'#231#227'o de Matriculados'
        Color = 15263976
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -21
  ...
  object QyCurso: TQuery
    DatabaseName = 'BDESisceb'
    SQL.Strings = (
      'SELECT * FROM Vw_NivelSerie'
      'where CodSerie = 15 and CodNivel =3')
    Left = 24
    Top = 48
    object QyCursoCodSerie: TIntegerField
      FieldName = 'CodSerie'
      Origin = 'BDEXPOENTE.Vw_NivelSerie.CodSerie'
    end
    object QyCursoCodNivel: TIntegerField
      FieldName = 'CodNivel'
      Origin = 'BDEXPOENTE.Vw_NivelSerie.CodNivel'
    end
    object QyCursoSerie: TStringField
      FieldName = 'Serie'
      Origin = 'BDEXPOENTE.Vw_NivelSerie.Serie'
      Size = 50
    end
    object QyCursoNivel: TStringField
      FieldName = 'Nivel'
  ...
  object QyAlunos: TQuery
    ...
    SQL.Strings = (
      ...
      'where CodNivel = :CodNivel and CodSerie = :CodSerie'
      'and Turma = '#39'A'#39' and Ano = 2007'
      'order by Nome')
    Left = 24
    Top = 16
    ParamData = <
    ...
    object QyAlunosMatricula: TIntegerField
      FieldName = 'Matricula'
      Origin = 'BDEXPOENTE.Vw_AlunosMatricula.Matricula'
    end
    ...
    object QyAlunosAno: TIntegerField
      FieldName = 'Ano'
      Origin = 'BDEXPOENTE.Vw_AlunosMatricula.Ano'
    end
    object QyAlunosTurma: TStringField
      FieldName = 'Turma'
      Origin = 'BDEXPOENTE.Vw_AlunosMatricula.Turma'
      FixedChar = True
      Size = 1
    end
    object QyAlunosSituacao: TStringField
      FieldName = 'Situacao'
      Origin = 'BDEXPOENTE.Vw_AlunosMatricula.Situacao'
      FixedChar = True
      Size = 15
    end
    object QyAlunosDt_Matricula: TDateTimeField
      FieldName = 'Dt_Matricula'
      Origin = 'BDEXPOENTE.Vw_AlunosMatricula.Dt_Matricula'
    end
