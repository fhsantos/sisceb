object frmRelDiarioNotasColegio: TfrmRelDiarioNotasColegio
  Left = 431
  Top = 59
  Width = 1036
  Height = 629
  ...
  object QyDetalhe: TQuery
    ...
    object QyDetalheUnid5: TStringField
      FieldName = 'Unid5'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.Unid5'
      FixedChar = True
      Size = 4
    end
    object QyDetalheUnid6: TStringField
      FieldName = 'Unid6'
      Origin = 'BDSISCEB.Vw_Matricula_Disciplinas.Unid6'
      FixedChar = True
      Size = 4
    end
  end
