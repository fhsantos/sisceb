object frmRelMatricula: TfrmRelMatricula
  Left = 169
  Top = 82
  Width = 796
  Height = 715
  ...
  object QuickRep1: TQuickRep
    ...
    object QRSubDetail1: TQRSubDetail
      ...
      object QRExpr11: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'QyDetalhe.Disciplina'
        FontSize = 8
      end
      object QRExpr5: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'QyDetalhe.CargaHoraria'
        FontSize = 8
      end
    end
    object TitleBand1: TQRBand
      ...
      object QRLabel1: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'COMPROVANTE DE MATR'#205'CULA'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
    ...
    object SummaryBand2: TQRBand
      ...
      object QRExpr9: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(QyDetalhe.CargaHoraria)'
        FontSize = 9
      end
      ...
      object QRLabel5: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'O pagamento dever'#225' ser feito at'#233' o quinto dia '#250'til de cada m'#234's;'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -12
      ...
      object QRLabel6: TQRLabel
        ...
        AutoStretch = False
        Caption = 
          'Em caso de desist'#234'ncia, o aluno dever'#225' comunicar por escrito '#224' S' +
          'ecretaria at'#233' 10 dias antes da data de vencimento da mensalidade' +
          ';'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
      ...
      object QRLabel8: TQRLabel
        ...
        AutoStretch = False
        Caption = 
          'Ser'#225' cobrada uma taxa de cancelamento no valor de 100% da mensal' +
          'idade;'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
      ...
      object QRLabel14: TQRLabel
        ...
        AutoStretch = False
        Caption = 
          'Em caso de desist'#234'ncia e do n'#227'o cumprimento da cl'#225'usula 2'#186', no p' +
          'razo de 30 dias, o nome ser'#225' inclu'#237'do no servi'#231'o de prote'#231#227'o ao ' +
          'cr'#233'dito;'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
      ...
      object QRLabel15: TQRLabel
        ...
        AutoStretch = False
        Caption = 
          'Autorizo o nome do meu nome e imagem para divulga'#231#227'o, caso seja ' +
          'aprovado..'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
      ...
      object QRLabel21: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Itabaiana(SE),___________de_____________________de 20______.'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -12
      ...
      object QRLabel24: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Assinatura do aluno ou Respons'#225'vel'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -12
  ...
  object QyDetalhe: TQuery
    ...
    object QyDetalheRec: TStringField
      FieldName = 'Rec'
      Origin = 'BDACADEMICO.Vw_Matricula_Disciplinas.Rec'
      FixedChar = True
      Size = 4
    end
  ...
  object qyparametros: TQuery
    DatabaseName = 'BDESisceb'
    SQL.Strings = (
      'SELECT * FROM Tb_Config')
    Left = 240
    Top = 15
    object qyparametrosRazao: TStringField
      FieldName = 'Razao'
      Origin = 'BDESISCEB.Tb_Config.Razao'
      Size = 100
    end
    object qyparametrosCNPJ: TStringField
      FieldName = 'CNPJ'
      Origin = 'BDESISCEB.Tb_Config.CNPJ'
      FixedChar = True
      Size = 16
    end
    object qyparametrosEndereco: TStringField
      FieldName = 'Endereco'
      Origin = 'BDESISCEB.Tb_Config.Endereco'
      Size = 80
    end
    object qyparametrosTel: TStringField
      FieldName = 'Tel'
      Origin = 'BDESISCEB.Tb_Config.Tel'
      FixedChar = True
      Size = 12
    end
    object qyparametrosFax: TStringField
      FieldName = 'Fax'
      Origin = 'BDESISCEB.Tb_Config.Fax'
      FixedChar = True
      Size = 12
    end
    object qyparametrosAno: TIntegerField
      FieldName = 'Ano'
      Origin = 'BDESISCEB.Tb_Config.Ano'
    end
    object qyparametrosDigito: TIntegerField
      FieldName = 'Digito'
      Origin = 'BDESISCEB.Tb_Config.Digito'
    end
    object qyparametrosDigitoProvao: TIntegerField
      FieldName = 'DigitoProvao'
      Origin = 'BDESISCEB.Tb_Config.DigitoProvao'
    end
    object qyparametrosMedia: TFloatField
      FieldName = 'Media'
      Origin = 'BDESISCEB.Tb_Config.Media'
    end
    object qyparametrosMediaEja: TFloatField
      FieldName = 'MediaEja'
      Origin = 'BDESISCEB.Tb_Config.MediaEja'
    end
  end
end
