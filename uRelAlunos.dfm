object frmRelAlunos: TfrmRelAlunos
  ...
  object QuickRep1: TQuickRep
    ...
    object DetailBand1: TQRBand
      ...
      object QRLabel18: TQRLabel
        ...
        AutoStretch = False
        Caption = 
          'Janeiro:____________ Fevereiro: ____________ Mar'#231'o: ____________' +
          ' Abril: ____________ Maio: _________'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -12
      ...
      object QRLabel19: TQRLabel
        ...
        AutoStretch = False
        Caption = 
          'Junho:____________ Julho: ____________ Agosto: ____________ Sete' +
          'mbro: ____________ Outubro: _______'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -12
      ...
      object QRLabel21: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Cl'#225'usulas Contraturais:'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
      ...
      object QRLabel22: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'O PAGAMENTO DEVER'#193' SER FEITO AT'#201' O QUINTO DIA '#218'TIL DE CADA M'#202'S;'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
      ...
      object QRLabel23: TQRLabel
        ...
        AutoStretch = False
        Caption = 
          'EM CASO DE DESIST'#202'NCIA, O ALUNO DEVER'#193' COMUNICAR POR ESCRITO '#193' S' +
          'ECRETARIA ESCOLA, AT'#201' 10(DEZ) DIAS ANTES DA DATA DE VENCIMENTO D' +
          'A MENSALIDADE;'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
      ...
      object QRLabel25: TQRLabel
        ...
        AutoStretch = False
        Caption = 
          'SER'#193' COBRADO TAXA DE CANCELAMENTO NO VALOR DE 100% DA MENSALIDAD' +
          'E;'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
      ...
      object QRLabel26: TQRLabel
        ...
        AutoStretch = False
        Caption = 
          'EM CASO DE DESIST'#202'NCIA E DO N'#195'O CUMPRIMENTO DA CL'#193'USULA 2'#186', NO P' +
          'RAZO DE 30 DIAS, O NOME SER'#193' INCLUIDO NO SERVI'#199'O DE PROTE'#199#195'O AO ' +
          ' CREDITO;'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
      ...
      object QRLabel27: TQRLabel
        ...
        AutoStretch = False
        Caption = 
          'AUTORIZO O USO DO MEU NOME E IMAGEM PARA DIVULGA'#199#195'O, CASO SEJA A' +
          'PROVADO.'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
      ...
      object QRLabel28: TQRLabel
        ...
        AutoStretch = False
        Caption = 
          'AP'#211'S O VENCIMENTO DA MENSALIDADE SER'#193' COBRADO, JUROS DE 2% AO M'#202 +
          'S MAIS R$ 0,15 AO DIA;'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
      ...
      object QRLabel29: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'ITABAIANA (SE), _____/_____/_____.'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -12
      ...
      object QRLabel31: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'ASSINATURA DO RESPONS'#193'VEL'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -12
      ...
      object QRExpr10: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'QyMaster.Pai + '#39' '#39' + '#39'e'#39' + '#39' '#39' + QyMaster.Mae'
        FontSize = 9
      end
    ...
    object TitleBand1: TQRBand
      ...
      object QRLabel1: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Ficha de Matr'#237'cula - 2010'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -21
  ...
  object QyMaster: TQuery
    ...
    Left = 24
    Top = 8
    object QyMasterMatricula: TIntegerField
      FieldName = 'Matricula'
      Origin = 'BDEXPOENTE.Vw_Alunos.Matricula'
    end
    object QyMasterNome: TStringField
      FieldName = 'Nome'
      Origin = 'BDEXPOENTE.Vw_Alunos.Nome'
      Size = 80
    end
    object QyMasterPai: TStringField
      FieldName = 'Pai'
      Origin = 'BDEXPOENTE.Vw_Alunos.Pai'
      Size = 80
    end
    object QyMasterMae: TStringField
      FieldName = 'Mae'
      Origin = 'BDEXPOENTE.Vw_Alunos.Mae'
      Size = 80
    end
    object QyMasterDt_Nasc: TDateTimeField
      FieldName = 'Dt_Nasc'
      Origin = 'BDEXPOENTE.Vw_Alunos.Dt_Nasc'
    end
    object QyMasterDt_Cadastro: TDateTimeField
      FieldName = 'Dt_Cadastro'
      Origin = 'BDEXPOENTE.Vw_Alunos.Dt_Cadastro'
    end
    object QyMasterBairro: TStringField
      FieldName = 'Bairro'
      Origin = 'BDEXPOENTE.Vw_Alunos.Bairro'
      Size = 50
    end
    object QyMasterEndereco: TStringField
      FieldName = 'Endereco'
      Origin = 'BDEXPOENTE.Vw_Alunos.Endereco'
      Size = 80
    end
    object QyMasterCEP: TStringField
      FieldName = 'CEP'
      Origin = 'BDEXPOENTE.Vw_Alunos.CEP'
      FixedChar = True
      Size = 8
    end
    object QyMasterTel: TStringField
      FieldName = 'Tel'
      Origin = 'BDEXPOENTE.Vw_Alunos.Tel'
      Size = 50
    end
    object QyMasterCI: TStringField
      FieldName = 'CI'
      Origin = 'BDEXPOENTE.Vw_Alunos.CI'
      Size = 50
    end
    object QyMasterCPF: TStringField
      FieldName = 'CPF'
      Origin = 'BDEXPOENTE.Vw_Alunos.CPF'
      Size = 50
    end
  end
end
