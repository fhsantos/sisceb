...
type
  TfrmRelDiarioNotasColegio = class(TForm)
    QuickRep1: TQuickRep;
...
var
  frmRelDiarioNotasColegio: TfrmRelDiarioNotasColegio;

implementation

{$R *.DFM}

procedure TfrmRelDiarioNotasColegio.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  qymaster.close;
  QyDetalhe.close;
  Release;
  frmRelDiarioNotasColegio:= nil;
end;

procedure TfrmRelDiarioNotasColegio.QyDetalheCalcFields(DataSet: TDataSet);
var
 Valor:STRING;
...
begin
 try
  QyConfig.open;
  if ((QyDetalheUnid1.Value <> '**') and (QyDetalheUnid2.Value = '**') and (QyDetalheUnid3.Value = '**') and
      (QyDetalheUnid4.Value = '**') and (QyDetalheUnid5.Value = '**') and (QyDetalheUnid6.Value = '**')) then
    begin
  ...
  else if ((QyDetalheUnid1.Value = '**') and (QyDetalheUnid2.Value <> '**') and (QyDetalheUnid3.Value = '**') and
           (QyDetalheUnid4.Value = '**') and (QyDetalheUnid5.Value = '**') and (QyDetalheUnid6.Value = '**')) then
    begin
